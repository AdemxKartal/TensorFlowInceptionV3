...
if __name__ == '__main__':
    ...
    def valid_step(images, labels):
        ...
        v_loss_aux= loss_object(y_true=labels, y_pred=predictions)
        v_loss = 0.5*v_loss_aux+0.5*loss_object(y_true=labels, y_pred=predictions)
        valid_loss(v_loss)
    ...
    for epoch in range(EPOCHS):
        ...
        step = 0
        for images, labels in TrainingBatch:
            ...
            print("Epoch: {}/{}, step: {}/{}, loss: {:.5f}, accuracy: {:.5f}".format(epoch + 1,
                                                                                     EPOCHS,
                                                                                     step,
                                                                                     math.ceil(TrainingSetNumber / BatchSize),
                                                                                     train_loss.result(),
